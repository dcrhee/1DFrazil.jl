...
end_name = "fast_same_C_" * string(numSizeClasses) * "_T_" * string(Tdiff)
...
simulation = Simulation(model, Δt=1.0, stop_time=48hours)
...
conjure_time_step_wizard!(simulation, cfl=1.0, max_Δt=5minute)#0.01minute)
