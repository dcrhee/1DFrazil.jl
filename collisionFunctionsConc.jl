...
if crystal_size_collision_redistribution == 2
    end_name = end_name * "_redistribute_"
end
...
simulation = Simulation(model, Δt=1e5, stop_time=7000hours)
...
conjure_time_step_wizard!(simulation, cfl=1.0, max_Δt=24hours)#0.01minute)
